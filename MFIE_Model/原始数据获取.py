...
import importlib
import raw_data_fetch 
importlib.reload(raw_data_fetch) 
...
if __name__ == '__main__':
    ...
    df = pd.read_csv(os.path.join(path, "industry_zx.csv"), index_col=[0], engine='python', encoding='gb18030')
    ...
    new_df.to_csv(os.path.join(path, 'industry_citic.csv'), encoding='gb18030')
    '''